		...
		<div class="w-full">
			...
			<div id="grupo" class="w-full bg-white text-white">
				<div class="flex flex-wrap h-screen">
					...
					<div class="w-full md:w-1/3 flex justify-center items-center flex-col gap-4 p-8 item-group" style="background-color: #DD4635;">
					...
					<div class="w-full md:w-1/3 flex justify-center items-center flex-col gap-4 p-8 item-group" style="background-color: #9E1E3B;">
